...
{
	$to = 'info@kyukatsu.com';
	$subject = '[PC]イケダハヤトのイベント参加';
	...
	$message .= '<h2 style="background-color: #eeeeee;">[PC]イケダハヤトのイベント参加</h2><table cellspacing="0" cellpadding="0" width="100%" style="background-color: #ffffff;">'; 
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>名前:</b></td><td>' . htmlentities($_REQUEST["custom_U1682"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
