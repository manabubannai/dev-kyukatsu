...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>名前:</b></td><td>' . htmlentities($_REQUEST["custom_U2380"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
