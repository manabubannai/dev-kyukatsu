...
{
	$to = 'mnbmnb0524@gmail.com';
	$subject = '[スマホ]イケダハヤトのイベント参加';
	...
	$message .= '<h2 style="background-color: #eeeeee;">[スマホ]イケダハヤトのイベント参加</h2><table cellspacing="0" cellpadding="0" width="100%" style="background-color: #ffffff;">'; 
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>名前:</b></td><td>' . htmlentities($_REQUEST["custom_U2545"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  mnbmnb0524@gmail.com' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 6.0.751 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"http://kyukatsu.com/i-hayato-thanks/"}}';
